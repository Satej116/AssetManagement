...
{
    public class ServiceRequestRepositoryDb
        : RepositoryDb<int, ServiceRequest>, IServiceRequestRepository
    {
        public ServiceRequestRepositoryDb(AssetManagementDbContext context) : base(context)
        {
        }
        ...
        // IServiceRequestRepository methods
